...
#[get("/items/:id")]
pub async fn get(_db: Db, Path(id): Path<i64>) -> Json<Item> {
    // TODO: query database
    Json(Item {
        id,
...
#[post("/items")]
pub async fn create(_db: Db, Json(body): Json<CreateItem>) -> Json<Item> {
...
#[put("/items/:id")]
pub async fn update(_db: Db, Path(id): Path<i64>, Json(body): Json<CreateItem>) -> Json<Item> {
...
#[delete("/items/:id")]
pub async fn delete(_db: Db, Path(id): Path<i64>) -> Json<serde_json::Value> {
